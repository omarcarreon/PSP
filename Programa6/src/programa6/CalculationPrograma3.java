 ...
 * @version 1.0
 */
//&p-CalculationPrograma3
//&b=53
package programa6;

public class CalculationPrograma3 {
    /*
     * sumatoriaXY
     * 
    ...
    public static Double sumatoriaXY(Integer iN) {
        ...
        Integer iIndex = 0;
        while(iIndex < iN){
            dSumatoria += Programa6.lstParejas.get(iIndex).getX() * Programa6.lstParejas.get(iIndex).getY(); //&m
            iIndex++;
        }
        return dSumatoria;
    }
    ...
    public static Double sumatoriaX(Integer iN) {
        ...
        Integer iIndex = 0;
        while(iIndex < iN){
            dSumatoria += Programa6.lstParejas.get(iIndex).getX(); //&m
            iIndex++;
        }
        return dSumatoria;
    }
    ...
    public static Double sumatoriaX2(Integer iN) {
        ...
        Integer iIndex = 0;
        while(iIndex < iN){
            dSumatoria += Programa6.lstParejas.get(iIndex).getX() * Programa6.lstParejas.get(iIndex).getX(); //&m
            iIndex++;
        }
        return dSumatoria;
    }
    ...
    public static Double sumatoriaY2(Integer iN) {
        ...
        Integer iIndex = 0;
        while(iIndex < iN){
            dSumatoria += Programa6.lstParejas.get(iIndex).getY() * Programa6.lstParejas.get(iIndex).getY(); //&m
            iIndex++;
        }
        return dSumatoria;
    }
    ...
    public static Double sumatoriaY(Integer iN) {
        ...
        Integer iIndex = 0;
        while(iIndex < iN){
            dSumatoria += Programa6.lstParejas.get(iIndex).getY(); //&m
            iIndex++;
        }
        return dSumatoria;
    }
    ...
    public static Double calculateB1(Double dSumatoriaXY, Integer iN, Double dPromedioX, Double dPromedioY, Double dSumatoriaX2) {
        ...
        calculation = (dSumatoriaXY- ((iN * 1.0) * dPromedioX * dPromedioY))/(dSumatoriaX2 - ((iN * 1.0) * Math.pow(dPromedioX, 2.0)));
        return calculation;
    }
    ...
    public static Double calculateRxy(Integer iN, Double dSumatoriaXY, Double dSumatoriaX, Double dSumatoriaY, Double dSumatoriaX2, Double dSumatoriaY2) {
        Double calculation = 0.0;
        calculation = ((iN * 1.0) * (dSumatoriaXY) - (dSumatoriaX * dSumatoriaY))/(Math.sqrt((((iN * 1.0) * dSumatoriaX2) - Math.pow(dSumatoriaX, 2.0))* (((iN * 1.0) * dSumatoriaY2) - Math.pow(dSumatoriaY, 2.0))));
        return calculation;
    }
     ...
     * @param dB1 es el valor <code>double</code> del valor de B1
     * @param dXk es el valor <code>double</code> del valor de xk
     * @return un valor <code>double</code> que representa el cálculo del valor de yk
     */
    //&i
    public static Double calculateYk(Double dB0, Double dB1, Double dXk) { //&m
        Double calculation = 0.0;
        calculation = dB0 + (dB1 * (dXk * 1.0)); //&m
        return calculation;
    }
}
